...
const FALLBACK_BG = ['#0a0a0a', '#1a1410', '#0d1117']
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-3 z-20">
        {data.map((_, i) => (
          <button
            ...
            className={`h-1 rounded-full transition-all duration-500 ${i === active ? 'w-8 bg-luxury-gold' : 'w-1 bg-luxury-white/40 hover:bg-luxury-white/70'}`}
          />
        ))}
      </div>
    </div>
